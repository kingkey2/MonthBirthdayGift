    ...
    class Program {
        ...
        static void QueryThread_Loop() {
            ...
            while (true) {
                ...
                ret = MgmtAPI.SendVIPMonthGift(hash);

                if (ret != null) {
                    if (ret.Result == OcwPHVipPromotion.MgmtAPI.enumResult.OK) {
                    } else {
                        errMsg += "MonthGift Exception Msg:" + ret.Message;
                    }
                }


                ret1 = MgmtAPI.SendVIPBirthdayGift(hash, searchMonth);
                if (ret1 != null) {
                    if (ret1.Result == OcwPHVipPromotion.MgmtAPI.enumResult.OK) {

                    } else {
                        errMsg += " BirthdayGift Exception Msg:" + ret.Message;
                    }
                }
